...
const seedDefaultUsers = async () => {
  try {
    ...
    if (count === 0) {
      ...
      const defaultUsers = [
        { name: 'Arpit', email: 'arpit@example.com', password: 'Password123', designation: 'Software Engineer' },
        { name: 'Shreya', email: 'shreya@example.com', password: 'Password123', designation: 'Product Designer' },
        { name: 'Nikhil', email: 'nikhil@example.com', password: 'Password123', designation: 'QA Lead' },
        { name: 'Piyush', email: 'piyush@example.com', password: 'Password123', designation: 'Project Manager' },
